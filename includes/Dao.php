...
/**
	...
	/**
	 * Add user with first_name, last_name, email, password, and username.
	 */
	public function addUser($fname, $lname, $email, $password, $username){
		...
		$query = "INSERT INTO user (first_name, last_name, email, password, username)
								values(:fname, :lname, :email, :password, :username)";
		$stmt = $connection->prepare($query);
